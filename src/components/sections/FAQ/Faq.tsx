  ...
  return (
    <div className="faq" id="faq">
      <div className="faq__title-block">
        <TittleButton type="h2">{faqSqreen.tag}</TittleButton>
        <BlockTittle className="faq__tittle">
          <>{faqSqreen.title_row1}</>
        </BlockTittle>
      </div>
      <h2 className="faq__title-add">{faqSqreen.title_row2}</h2>
      <Swiper
      ...
      >
        <div
          className="faq__navigation faq__navigation--left"
          onClick={() => swiperRef.current?.slidePrev()}
        >
          <Arrow />
        </div>
        <div
          className="faq__navigation faq__navigation--right"
          ...
          <SwiperSlide className="faq__slide" key={video}>
            <div className="faq__video">
              <div className="faq__video-dummy" onClick={handleVideoClick}>
                <div
                  className={`faq__play-pause ${
                    play ? "faq__play-pause--hidden" : ""
                  }`}
                >
                  <PlayIcon />
                </div>
